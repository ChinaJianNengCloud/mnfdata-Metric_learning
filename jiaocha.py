...
if __name__ == '__main__':
    ...
    for fold, (train_index, val_index) in enumerate(kf.split(data)):
        for i in range(3):
            name_data = f"data_{fold}_{i}"
            exp_name = f"{name_data}"
            log_dir = fr"E:\yinda\mnf\result\jiaochaMLP_newdata\{exp_name}\log"
            tensorboard_dir = fr"E:\yinda\mnf\result\jiaochaMLP_newdata\{exp_name}\tensorboard"
            model_save_dir = fr"E:\yinda\mnf\result\jiaochaMLP_newdata\{exp_name}\model"
