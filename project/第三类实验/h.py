...
if __name__ == '__main__':
    ...
    # embedder_scheduler = torch.optim.lr_scheduler.ExponentialLR(embedder_optimizer, gamma=0.99)
    # classifier_scheduler = torch.optim.lr_scheduler.ExponentialLR(classifier_optimizer, gamma=0.99)
    lr_dict={
    ...
    # 计算每个类别的权重
    weight_for_class_0 = total_samples / (2 * 212)
    weight_for_class_1 = total_samples / (2 * 106)
    ...
    loss_weights = { "classifier_loss": 1}
    ...
    hooks = logging_presets.get_hook_container(record_keeper,record_group_name_prefix="best_acc_auc_yinda",primary_metric="mean_acc_auc_yinda")
