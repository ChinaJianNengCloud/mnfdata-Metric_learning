...
if __name__ == '__main__':
    ...
    for i in range(30):
        ...
        exp_name = f"shiyan11-Supconloss-embeding_output{embedding_output}-temperature{temperature}-epsilons{epsilons}-{i}"
        # exp_name = "test"
        log_dir = fr"/root/autodl-tmp/result/Lossresult/youhua/Supconloss/{exp_name}/log"
        tensorboard_dir = fr"/root/autodl-tmp/result/Lossresult/youhua/Supconloss/{exp_name}/tensorboard"
        model_save_dir = fr"/root/autodl-tmp/result/Lossresult/youhua/Supconloss/{exp_name}/model"
        ...
        loss =losses.SupConLoss(temperature=temperature)
