...
if __name__ == '__main__':
    ...
    for i in range(30):
        ...
        exp_name = f"shiyan11-Multisimilarity-nominer-embeding_output{embedding_output}-alpha{alpha}-beta{beta}-base{base}-{i}"
        # exp_name = "test"
        log_dir = fr"/root/autodl-tmp/result/Lossresult/youhua/Multisimilarity-nominer/{exp_name}/log"
        tensorboard_dir = fr"/root/autodl-tmp/result/Lossresult/youhua/Multisimilarity-nominer/{exp_name}/tensorboard"
        model_save_dir = fr"/root/autodl-tmp/result/Lossresult/youhua/Multisimilarity-nominer/{exp_name}/model"
