...
if __name__ == '__main__':
    ...
    pos_epss= [0.01, 0.03, 0.05, 0.07, 0.09]
    neg_epss=[0.01, 0.03, 0.05, 0.07, 0.09]
    for i in range(30):
        embedding_output = random.choice(embedding_outputs)
        pos_eps = random.choice(pos_epss)
        neg_eps = random.choice(neg_epss)
        exp_name = f"shiyan11-IntraPairVarianceloss-nominer-embeding_output{embedding_output}-pos_eps{pos_eps}-neg_eps{neg_eps}-{i}"
        # exp_name = "test"
        log_dir = fr"/root/autodl-tmp/result/Lossresult/youhua/IntraPairVarianceloss-nominer/{exp_name}/log"
        tensorboard_dir = fr"/root/autodl-tmp/result/Lossresult/youhua/IntraPairVarianceloss-nominer/{exp_name}/tensorboard"
        model_save_dir = fr"/root/autodl-tmp/result/Lossresult/youhua/IntraPairVarianceloss-nominer/{exp_name}/model"
        freeze_support()
        ...
        loss = losses.IntraPairVarianceLoss(pos_eps=pos_eps, neg_eps=pos_eps)
