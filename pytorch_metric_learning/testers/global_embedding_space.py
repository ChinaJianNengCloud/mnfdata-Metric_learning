...
class GlobalEmbeddingSpaceTester(BaseTester):
    def do_knn_and_accuracies(
        self, accuracies, embeddings_and_labels,classifier_and_labels ,query_split_name, reference_split_names
    ):
        (
            query_embeddings,
            query_labels,
        ...
        classifier_and_label=classifier_and_labels[query_split_name]
        ...
        for L in self.label_levels:
            ...
            for metric, v in a.items():
                print(f'{query_split_name}{metric}: {v}')
